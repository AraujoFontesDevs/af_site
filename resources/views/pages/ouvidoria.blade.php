...
<body>
    ...
    <div class="container-fluid h-auto d-flex flex-column justify-content-center background-img-ouvidoria  px-5" id="mainCoverAbout">
        ...
        <div style="z-index: 1021;" class="col-12 col-sm-6">
            <h2 class="title-about-secondary"> Ouvidoria</h1>
                <br>
                <h1 class="title-about" style="font-size: 24px; max-width: 460px;">  A ouvidoria é um canal que objetiva melhorar a qualidade da comunicação entre a empresa e seus colaboradores e clientes. É uma oportunidade de fazer elogios, reclamações, solicitações. Enfim, um espaço para você falar o que quiser, de maneira sigilosa e, se preferir, anônima.</h1>
        </div>

        <div style="z-index: 1021; display:flex; align-items: center; border-radius: 8px; padding: 8px;" class="col-12 col-sm-6">
            <form style="margin-left: 12px" method="post" id="ouvidoria-form-ouvidoria">
                <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                <div class="mb-3 row">
                    <div class="col-sm-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="colaborador" name="colaborador">
                            <label class="form-check-label" for="colaborador" style="color: rgb(255, 255, 255)">
                             Sou um colaborador
                            </label>
                          </div>
                ...
                <div class="mb-3 row">
                    <div class="col-sm-12">
                        <button type="button" class="btn btn-primary" onclick="sendEmailOuvidoria()" style="background-color: #183967; border-color: #183967">Enviar</button>
                    </div>
                </div>
